...
#    Updated: 2023/06/05 15:24:35 by bpla-rub         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		=	src/main.c			    \
				...
				tokens/token_operator.c \
				tokens/tokens_nested.c  \
				tokens/token_single_q.c \
				tokens/token_double_q.c \
				tokens/expand_utils.c 	\
				tokens/expand_utils2.c 	\
				tokens/expand_env.c 	\
				tokens/expand_quotes.c 	\
				tokens/expand_env_helper.c 	\
				tokens/expand_env2_helper.c 	\
				tokens/expand_env2_helper2.c 	\
				tokens/expand_env2.c 	\
				tokens/expansion_original.c  \
				tokens/tokens_normal.c	\
				tokens/token_plain_text.c \
				...
				execution/check_access_redic.c
